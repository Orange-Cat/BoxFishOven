The BoxFishOven controller v1.4 supports multiple reflow, annealing and curing profiles selectable from the LCD display and a design that makes it easy to add new profiles.
